...
if (-Not (Test-Path "$scriptFolder\ThirdParty.1.5.0.nupkg")) {
    Invoke-WebRequest -OutFile "$scriptFolder\ThirdParty.1.5.0.nupkg" https://github.com/oussamamk/OpenCppCoverage/releases/download/v1.5.0/ThirdParty.1.5.0.nupkg
}
